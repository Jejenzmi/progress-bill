...
// Desain mengikuti template Quotation (header halftone, footer melengkung, TTE)

import { generateQRCodeDataURL, TTEData } from './qrCodeGenerator';
...
export const generateInvoicePDF = async (
  ...
  const verificationId = btoa(invoice.invoiceNumber).substring(0, 16).toUpperCase();
  
  // Get the published URL for verification
  ...
  // Convert logo to data URL for print reliability
      ...
      <div class="page">
        ...
        <div class="content">
          ...
          <div class="meta-grid">
            ...
            <div class="due-badge">Jatuh Tempo: ${formatDate(invoice.dueDate)}</div>
          </div>
          ...
          <div class="project-title">
            ${invoice.projectName}
            <div class="term-name">${invoice.termName}</div>
          </div>
          ...
          <div class="bank-info">
            ...
            <div class="bank-content">${company.bank_info}</div>
          </div>
